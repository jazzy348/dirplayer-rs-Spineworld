...
browser_e2e_test!(test_supersonic_load, |player| async move {
    ...
    player
        .step_until(datum("_movie.frame").equals(StaticDatum::Int(80)))
        .timeout(15.0)
        .await?;
    ...
    player
        .step_until(datum("_movie.frame").equals(StaticDatum::Int(95)))
        .timeout(15.0)
        .await?;
    ...
    player
        .step_until(datum("_movie.frame").equals(StaticDatum::Int(70)))
        .timeout(15.0)
        .await?;

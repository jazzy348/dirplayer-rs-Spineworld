...
browser_e2e_test!(test_mobilesdisco_load, |player| async move {
    ...
    player
        .step_until(datum("_movie.frame").equals(StaticDatum::Int(98)))
        .timeout(15.0)
        .await?;
    ...
    player
        .step_until(datum("_movie.frame").equals(StaticDatum::Int(104)))
        .timeout(15.0)
        .await?;
    ...
    player
        .step_until(datum("_movie.frame").equals(StaticDatum::Int(110)))
        .timeout(15.0)
        .await?;

...
browser_e2e_test!(test_junkbot_v2_load, |player| async move {
    ...
    player
        .step_until(datum("_movie.frame").equals(StaticDatum::Int(33)))
        .timeout(15.0)
        .await?;
    ...
    player
        .step_until(datum("_movie.frame").equals(StaticDatum::Int(27)))
        .timeout(15.0)
        .await?;
    ...
    player
        .step_until(sprite().member("haz_slickPipe_wet_7").visible(1.0))
        .await?;
    ...
    player
        .step_until(datum("_movie.frame").equals(StaticDatum::Int(16)))
        .timeout(15.0)
        .await?;

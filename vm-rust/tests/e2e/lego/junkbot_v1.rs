...
browser_e2e_test!(test_junkbot_v1_load, |player| async move {
    ...
    player
        .step_until(datum("_movie.frame").equals(StaticDatum::Int(7)))
        .timeout(20.0)
        .await?;

    player
        .step_until(sprite().member("skip_intro").visible(1.0))
        .await?;
    ...
    player
        .step_until(datum("_movie.frame").equals(StaticDatum::Int(29)))
        .timeout(15.0)
        .await?;
    ...
    player
        .step_until(datum("_movie.frame").equals(StaticDatum::Int(21)))
        .timeout(15.0)
        .await?;
    ...
    player
        .step_until(datum("_movie.frame").equals(StaticDatum::Int(24)))
        .timeout(15.0)
        .await?;
    ...
    player
        .step_until(sprite().member("haz_slickJump_dormant_1").visible(1.0))
        .await?;
    ...
    player
        .step_until(sprite().member("opening_memo").visible(1.0))
        .await?;
    ...
    player
        .step_until(sprite().member("building_icon_1").visible(1.0))
        .await?;
    ...
    player
        .step_until(datum("_movie.frame").equals(StaticDatum::Int(14)))
        .timeout(15.0)
        .await?;

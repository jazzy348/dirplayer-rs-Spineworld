            ...
            Ok({
                ...
                match other {
                    String(_) | StringChunk(..) => {
                        sstr.eq_ignore_ascii_case(&other.string_value_cow().expect("cannot fail"))
        ...
        (List(_, l, _), other) | (other, List(_, l, _)) => Ok({
            ...
            match other {
                List(_, r, _) => {
                    ...
                    seq_equals(&l_slice, &r_slice, allocator)?
                }
                Point(vals, flags) => {
                ...
                Rect(vals, flags) => {
                    ...
                    if l_slice.len() != 4 {
                        ...
                        for i in 0..4 {
                            ...
                            if !datum_equals(li, &ri, allocator)? {
                                eq = false;
                                break;
                            }
                        }
        ...
        (Rect(a_vals, a_flags), o) | (o, Rect(a_vals, a_flags)) => Ok(match o {
            Rect(b_vals, b_flags) => {
                ...
                for i in 0..4 {
                    ...
                    if !datum_equals(&ai, &bi, allocator)? {
                        eq = false;
                        break;
                    }
                }
...
pub fn datum_is_zero(datum: &Datum, datums: &DatumAllocator) -> Result<bool, ScriptError> {
    Ok(match datum {
        ...
        Datum::List(_, items, _) => items.is_empty(),
        Datum::PropList(items, _) => items.is_empty(),
        _ => {
